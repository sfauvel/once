...
public class ComparatorWithSubstitutionTest extends AbstractComparatorTest {
    ...
    public void testGetListeTrieeSansSubstitution() throws Exception {
        ...
        // 2:1, 1:12, 0:123 
        {
            ...
            assertThatSortedPosition(comparator, createPositionArray(3)).containsExactly(2, 1, 0);
        }
        {
            CodeComparator comparator = createComparatorWithCode("B A C");
            assertThatSortedPosition(comparator, createPositionArray(3)).containsExactly(2, 1, 0);
        }
    }
    ...
    public void testGetListeTrieeAvecSubstitution() throws Exception {
        ...
        CodeComparator comparator = createComparatorWithCode("A A B B");
        assertThatSortedPosition(comparator, createPositionArray(4)).containsExactly(3, 2, 0, 1);
    }

    @Test
    public void testCompareBasique() throws Exception {
        CodeComparator comparateur = new ComparatorWithSubstitution(createCode("a b c"));
    ...
    public void testCompareIdentiqueSurPlusieursValeurs() throws Exception {
        CodeComparator comparateur = new ComparatorWithSubstitution(createCode("a b c d e a b c x y"));
    ...
    public void testGetRedundancySizeCaractereNonInterchangeable() throws Exception {
        ...
        assertEquals(4, createComparatorWithCode("a a b x c c d z").getRedundancySize(0, 4));
        assertEquals(2, createComparatorWithCode("a a : x c c d z").getRedundancySize(0, 4));
        assertEquals(2, createComparatorWithCode("a a b x c c : z").getRedundancySize(0, 4));
        ...
        assertEquals(4, createComparatorWithCode("a a : x c c : z").getRedundancySize(0, 4));
    ...
    private CodeComparator createComparatorWithCode(String... tokenList) {
        return new ComparatorWithSubstitution(createCode(tokenList));
    }
}
